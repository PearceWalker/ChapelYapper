...
export default function SuggestFeature() {
  return (
    <div className="min-h-screen bg-[var(--sidebar-color)] flex flex-col items-center justify-center p-6 text-white">
      <Head>
        <title>Suggest a Feature | ChapYapper</title>
      </Head>
      <a
  href="/rooms"
...
>
  ...
  Back to rooms
      ...
      <h1 className="text-3xl font-bold mb-4">💡 Suggest a Feature</h1>
      <form
      ...
      >
        ...
        <input type="hidden" name="subject" value="ChapYapper Feature Suggestion" />

        <label className="block mb-2 font-medium">Your Email</label>
        <input type="email" name="email" required className="w-full p-2 mb-4 border rounded" />

        <label className="block mb-2 font-medium">Your Idea</label>
